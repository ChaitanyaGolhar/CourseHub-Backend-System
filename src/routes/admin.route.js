...
const { createCourseHandler, publish, unpublish, createSectionHandler, createLectureHandler, uploadThumbnail } = require("../controllers/admin.controller");
const { createCourseHandlerSchema, publishUnpublishSchema, createSectionHandlerScheme, createLectureHandlerScheme, uploadThumbnailScheme } = require("../validators/admin.validator");
